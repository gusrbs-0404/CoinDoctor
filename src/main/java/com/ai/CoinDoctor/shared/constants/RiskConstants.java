...
public class RiskConstants {
    ...
    // 서킷브레이커 관련
    public static final double CIRCUIT_BREAKER_THRESHOLD_PERCENT = -3.0;
    ...
    // 쿨다운 관련
    public static final long COOLDOWN_DURATION_SECONDS = 600; // 10분 (초)
    ...
    // 일일 손실 한도
    public static final double MAX_DAILY_LOSS_PERCENT = 50000.0; // 50,000원
